...
var mgenv = global.mgENV
 ...
 router.post('/develop/getmycourse', getmycourse); //获取task信息  
...
function updatetask(req,res,next){
    var task_id = req.body.task_id  , title =req.body.title, other_role_result = req.body.other_role_result, exam_id =  req.body.exam_id;
